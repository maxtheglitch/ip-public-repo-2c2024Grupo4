class Card:
    ...
    def __str__(self):
        return f'IMG URL: {self.title}, name: {self.name}, status: {self.status}, primera vez visto: {self.last_location}, última ubicación: {self.first_seen}, Usuario: {self.user}, Id: {self.id}'
